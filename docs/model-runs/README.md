...
| [LOOP-001 step/token budgets](LOOP-001-step-token-budgets.md) | LOOP-001 | [#25](https://github.com/Ayumu-J-S/llm_scratch/pull/25) (draft; cycle-3 re-review pending) | not exposed by runtime / not exposed by runtime | not exposed by runtime / not exposed by runtime | 2 | in progress | training-loop, token-weighting, cadence, numerical-stability, validation-evidence, runtime-identity |
