...
| [LOOP-001 metrics audit](LOOP-001-metrics-audit.md) | LOOP-001 | [#26](https://github.com/Ayumu-J-S/llm_scratch/pull/26) (draft; pending parent merge) | not exposed by runtime / not exposed by runtime | not exposed by runtime / not exposed by runtime | 0 | PASS WITH NOTE | metrics-lifecycle, offline-evidence, p2-repair, runtime-identity |
| [LOOP-001 metrics init-failure repair](LOOP-001-metrics-init-failure.md) | LOOP-001 | [#28](https://github.com/Ayumu-J-S/llm_scratch/pull/28) (draft) | not exposed by runtime / not exposed by runtime | pending | 0 | in progress | metrics-lifecycle, failure-preservation, atomic-write, p2-repair, runtime-identity |
