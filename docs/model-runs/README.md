...
| [CI-001 network-free quality gate](CI-001-network-free-quality-gate.md) | CI-001 | draft / pending creation | not exposed by runtime / not exposed by runtime | pending | 0 | in progress | ci-parity, offline-smoke, lock-drift, workflow-separation |
