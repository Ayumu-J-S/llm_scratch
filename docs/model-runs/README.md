...
| [DATA-003 deterministic stream cursor](DATA-003-stream-cursor.md) | DATA-003 | [#29](https://github.com/Ayumu-J-S/llm_scratch/pull/29) (draft) | not exposed by runtime / not exposed by runtime | not exposed by runtime / not exposed by runtime | 2 | in progress | deterministic-order, cursor-resume, repeat-policy, prefetch-equivalence, async-ack, pass-completion, process-cursor-propagation |
