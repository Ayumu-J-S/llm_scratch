...
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- | --- |
| not exposed by runtime / not exposed by runtime | 7 | 0 | 16 | 9 | 21 | Produced scoped EXP-001, DATA-001, DATA-002, guarded-policy, and canonical-tokenizer changes; localized causal-boundary, immutable-manifest, and tokenizer semantics; reviews found authority, lifecycle, identity, evidence, and workflow defects | One implementation stalled; two review attempts blocked; earlier data passes missed accounting, benchmark authority, lifecycle, and tokenizer/workflow integration defects; exact model attribution remains impossible | 2026-07-12 |
