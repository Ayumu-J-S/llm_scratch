...
| --- | --- | --- | --- | --- | ---: | --- | --- |
| [GATE-001 post-merge finalization](GATE-001-postmerge-finalize.md) | GATE-001 | [#40](https://github.com/Ayumu-J-S/llm_scratch/pull/40) (draft) | not exposed by runtime / not exposed by runtime | pending | 0 | in progress | post-merge-status, dependency-reconciliation, audit-parity |
