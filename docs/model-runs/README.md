...
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- | --- |
| not exposed by runtime / not exposed by runtime | 8 | 1 | 18 | 11 | 23 | Produced scoped EXP-001, DATA-001, DATA-002, MODEL-001, guarded-policy, and canonical-tokenizer changes; localized causal-boundary, immutable-manifest, tokenizer, and model-invariant semantics; reviews found authority, lifecycle, identity, evidence, and workflow defects and independently reproduced the original MODEL-001 CPU gates | One implementation stalled; two review attempts blocked; earlier passes missed accounting, benchmark authority, lifecycle, tokenizer/workflow integration, and exact accepted-plan assertions; MODEL-001 canonical integration is pending independent review; exact model attribution remains impossible | 2026-07-12 |
