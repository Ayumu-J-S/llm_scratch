...
| [DATA-003 P5 post-merge audit](DATA-003-p5-post-merge-audit.md) | DATA-003 | [#32](https://github.com/Ayumu-J-S/llm_scratch/pull/32) (draft) | not exposed by runtime / not exposed by runtime | not exposed by runtime / not exposed by runtime | 3 (exact-head no-drift review pending) | FAIL — full-trail repair pending | post-merge-audit, merge-evidence, stale-roadmap-state, validation-command, audit-completeness |
