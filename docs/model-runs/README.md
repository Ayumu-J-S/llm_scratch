...
| --- | --- | --- | --- | --- | ---: | --- | --- |
| [TOK-001 canonical tokenizer](TOK-001-canonical-tokenizer.md) | TOK-001 | [#12](https://github.com/Ayumu-J-S/llm_scratch/pull/12) | not exposed by runtime / not exposed by runtime | not exposed by runtime / not exposed by runtime | 2 | in progress | reproducibility, tokenizer-cost, offline-identity |
...
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- | --- |
| not exposed by runtime / not exposed by runtime | 2 | 0 | 2 | 0 | 2 | Pinned evidence selection; direct offline integration and review caught false handoff evidence | Initial invocation/import mismatch; fixture assumptions; unused manifest field; added files omitted from format check | 2026-07-11 |
