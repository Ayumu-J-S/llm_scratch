...
| [ENV-001 DGX Spark CUDA](ENV-001-dgx-spark-cuda.md) | ENV-001 | [#15](https://github.com/Ayumu-J-S/llm_scratch/pull/15) | not exposed by runtime / not exposed by runtime | not exposed by runtime / not exposed by runtime | 1 | PASS WITH NOTE - integration refresh pending | cuda-runtime, reproducibility, dgx-spark, evidence |
...
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- | --- |
| not exposed by runtime / not exposed by runtime | 9 | 1 | 19 | 12 | 25 | Produced scoped EXP-001, DATA-001, DATA-002, MODEL-001, ENV-001, guarded-policy, canonical-tokenizer, and provenance changes; localized causal-boundary, immutable-manifest, tokenizer, model-invariant, CUDA-boundary, source-separation, and final-head parity semantics; reviews found authority, lifecycle, identity, evidence, and workflow defects and independently reproduced the original MODEL-001 CPU gates | One implementation stalled; two review attempts blocked; earlier passes missed accounting, benchmark authority, lifecycle, tokenizer/workflow integration, exact accepted-plan assertions, provider/evidence labels, and provenance source precedence; MODEL-001 and ENV-001 current integration reviews are pending; exact model attribution remains impossible | 2026-07-12 |
