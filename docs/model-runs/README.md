...
| [CKPT-001 atomic full-state resume](CKPT-001-atomic-resume.md) | CKPT-001 | draft pending creation | not exposed by runtime / not exposed by runtime | pending | 3 | implementation repaired; independent review pending | resume, atomic-write, rotation, compatibility, stream-cursor, full-suite-regression, milestone-duplication, prefix-replay-guard |
