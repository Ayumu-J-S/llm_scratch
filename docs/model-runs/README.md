...
| --- | --- | --- | --- | --- | ---: | --- | --- |
| [GATE-001 bilingual overfit proof](GATE-001-bilingual-overfit-proof.md) | GATE-001 | [#39](https://github.com/Ayumu-J-S/llm_scratch/pull/39) (draft) | not exposed by runtime / not exposed by runtime | pending independent review | 4 | candidate complete; exact-head review pending | memorization, resume, reproducibility, generation, fixture-sizing, sampling-audit, formatting |
