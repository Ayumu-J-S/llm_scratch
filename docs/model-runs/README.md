...
| [STAB-001 stable training](STAB-001-stable-training.md) | STAB-001 | [#34](https://github.com/Ayumu-J-S/llm_scratch/pull/34) (draft) | not exposed by runtime / not exposed by runtime | pending independent review | 2 | implementation complete; review pending | numerical-stability, accumulation, bf16, scheduler, clipping-calibration, iterator-shutdown |
