...
| --- | --- | --- | --- | --- | ---: | --- | --- |
| [MODEL-001 baseline invariants](MODEL-001-baseline-invariants.md) | MODEL-001 | [#14](https://github.com/Ayumu-J-S/llm_scratch/pull/14) | not exposed by runtime / not exposed by runtime | not exposed by runtime / not exposed by runtime | 1 | PASS WITH NOTE | accepted-plan-coverage |
...
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- | --- |
| not exposed by runtime / not exposed by runtime | 1 | 1 | 1 | 1 | 1 | Bounded MODEL-001 change passed the predeclared invariant and CPU evidence gates; review independently reproduced adversarial padding, overfit, counts, and R1 | First test pass omitted exact accepted-plan assertions; standalone probe initially omitted repository import path | 2026-07-11 |
