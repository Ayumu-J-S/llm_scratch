...
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- | --- |
| not exposed by runtime / not exposed by runtime | 6 | 0 | 13 | 8 | 18 | Produced scoped EXP-001, DATA-001, guarded-policy, and canonical-tokenizer changes; localized causal-boundary and raw/control-token semantics; reviews found evidence, lifecycle, state, authorization, expected-check, tokenizer identity, and manifest-integrity defects and cleared TOK integration without findings | One implementation stalled; two review attempts blocked; initial DATA-001 process-prefetch accounting was stale; EXP and policy evidence/state repeatedly needed reconciliation; TOK initially accepted raw controls and aliased special roles; exact model attribution remains impossible | 2026-07-12 |
