...
| --- | --- | --- | --- | --- | ---: | --- | --- |
| [GATE-001 post-merge finalization](GATE-001-postmerge-finalize.md) | GATE-001 | [#40](https://github.com/Ayumu-J-S/llm_scratch/pull/40) (draft) | not exposed by runtime / not exposed by runtime | FAIL `4680818667`; model/mode not exposed | 1 | FAIL — two documentation parity findings under repair | post-merge-status, dependency-reconciliation, audit-parity, stale-final-status, provenance-target |
