...
| [DATA-003 deterministic stream cursor](DATA-003-stream-cursor.md) | DATA-003 | draft / pending creation | not exposed by runtime / not exposed by runtime | pending | 0 | in progress | deterministic-order, cursor-resume, repeat-policy, prefetch-equivalence |
