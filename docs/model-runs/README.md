...
| --- | --- | --- | --- | --- | ---: | --- | --- |
| [DATA-001 causal boundaries](DATA-001-causal-boundaries.md) | DATA-001 | draft pending | pending | pending | 0 | in progress | ml-semantics, token-accounting, boundary-policy |
