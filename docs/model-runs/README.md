...
| --- | --- | --- | --- | --- | ---: | --- | --- |
| [ENV-001 DGX Spark CUDA](ENV-001-dgx-spark-cuda.md) | ENV-001 | [#15](https://github.com/Ayumu-J-S/llm_scratch/pull/15) | not exposed by runtime / not exposed by runtime | not exposed by runtime / not exposed by runtime | 1 | PASS WITH NOTE | reproducibility |
...
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- | --- |
| not exposed by runtime / not exposed by runtime | 1 | 0 | 1 | 1 | 2 | Small fail-closed CUDA boundary; real DGX evidence; independent review found subtle contract/provenance gaps | Initial diagnostic probing, provider classification, and evidence labels needed repair | 2026-07-11 |
