...
| [DATA-003 P5 final post-merge audit](DATA-003-p5-final-postmerge-audit.md) | DATA-003 | [#33](https://github.com/Ayumu-J-S/llm_scratch/pull/33) (draft) | not exposed by runtime / not exposed by runtime | pending | 0 | in progress | post-merge-ledger, final-audit, merge-evidence |
