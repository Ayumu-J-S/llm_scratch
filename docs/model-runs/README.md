...
| --- | --- | --- | --- | --- | ---: | --- | --- |
| [DATA-004 pinned baseline mixture](DATA-004-pinned-baseline-mixture.md) | DATA-004 | [#41](https://github.com/Ayumu-J-S/llm_scratch/pull/41) (draft) | not exposed by runtime / not exposed by runtime | FAIL `4680931313`; model/mode not exposed | 2 | technical repair and evidence complete at `fee0f1a` / `458dbdc`; independent re-review pending; unresolved source-rights policy gate blocks agent self-merge | data-quality, split-leakage, document-identity, token-mixture, cache-headroom, source-provenance, iterator-lifecycle, evidence-completeness, config-reproducibility, legal-policy |
