...
| [GEN-001 base-model continuation](GEN-001-base-continuation.md) | GEN-001 | draft — branch pushed; PR URL pending | not exposed by runtime / not exposed by runtime | pending independent review | 0 | in progress | checkpoint-reconstruction, deterministic-sampling, generation-boundaries |
