...
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- | --- |
| not exposed by runtime / not exposed by runtime | 9 | 1 | 19 | 12 | 26 | Produced scoped EXP-001, DATA-001, DATA-002, MODEL-001, ENV-001, guarded-policy, canonical-tokenizer, and provenance changes; localized causal-boundary, immutable-manifest, tokenizer, model-invariant, CUDA-boundary, source-separation, and final-head parity semantics; reviews found authority, lifecycle, identity, evidence, and workflow defects and independently reproduced the original MODEL-001 CPU gates | One implementation stalled; two review attempts blocked; earlier passes missed accounting, benchmark authority, lifecycle, tokenizer/workflow integration, exact accepted-plan assertions, provider/evidence labels, and provenance source precedence; remaining notes are R1/R2 scope and evidence limitations, not pending MODEL/ENV verdicts; exact model attribution remains impossible | 2026-07-12 |
