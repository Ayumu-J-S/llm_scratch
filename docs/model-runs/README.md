...
| [DATA-003 packed resume repair](DATA-003-packed-resume-repair.md) | DATA-003 | draft | not exposed by runtime / not exposed by runtime | not exposed by runtime / not exposed by runtime | 1 (in progress) | in progress | resume, packed-cursor, token-accounting |
...
| [DATA-003 deterministic stream cursor](DATA-003-stream-cursor.md) | DATA-003 | [#29](https://github.com/Ayumu-J-S/llm_scratch/pull/29) (merged `57266e1`; post-merge P2 repair pending) | not exposed by runtime / not exposed by runtime | not exposed by runtime / not exposed by runtime | 3 | FAIL — repair pending | deterministic-order, cursor-resume, packed-cursor-resume, post-merge-reopen, repeat-policy, prefetch-equivalence, async-ack, pass-completion, process-cursor-propagation, process-reuse |
...
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- | --- |
| not exposed by runtime / not exposed by runtime | 12 | 2 | 26 | 19 | 39 | Produced scoped EXP-001, DATA-001, DATA-002, MODEL-001, ENV-001, CFG-001, REP-001, LOOP-001, guarded-policy, canonical-tokenizer, and provenance changes; localized causal-boundary, immutable-manifest, tokenizer, model-invariant, CUDA-boundary, profile/preflight, source-separation, run-identity, global-seeding, training-loop, token-weighting, metrics-lifecycle, W&B-failure preservation, final-head parity semantics, and a scoped post-merge status correction; reviews found authority, lifecycle, identity, evidence, guard-ordering, numerical-health, validation-evidence, workflow defects, and a post-merge packed-cursor residual duplication | One implementation stalled; two review attempts blocked; LOOP-001 initial review found missing non-finite-state guards, token cadences, aggregate metrics, and strict budget safety, follow-up reviews found validation evidence context and metrics-lifecycle/W&B-init preservation gaps before repair; REP-001 follow-up review found missing dirty-worktree verification after the initial guard-ordering repair; CFG-001 first review found and repair closed an evaluation execution-path contradiction and profile coupling; DATA-003 post-merge review found final-partial packed residual duplication, while the subsequent successful repair was documentation-only and leaves code repair pending; earlier passes missed accounting, benchmark authority, lifecycle, tokenizer/workflow integration, exact accepted-plan assertions, provider/evidence labels, and provenance source precedence; exact model attribution remains impossible | 2026-07-12 |
