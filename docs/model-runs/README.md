...
| [STAB-001 stable training](STAB-001-stable-training.md) | STAB-001 | draft | not exposed by runtime / not exposed by runtime | pending independent review | 0 | in progress | numerical-stability, accumulation, bf16, scheduler |
