...
| [LOOP-001 metrics init-failure repair](LOOP-001-metrics-init-failure.md) | LOOP-001 | [#28](https://github.com/Ayumu-J-S/llm_scratch/pull/28) (ready; pending parent merge) | not exposed by runtime / not exposed by runtime | not exposed by runtime / not exposed by runtime | 0 | PASS WITH NOTE | metrics-lifecycle, failure-preservation, atomic-write, p2-repair, runtime-identity |
