...
| [CFG-001 canonical Hydra](CFG-001-canonical-hydra.md) | CFG-001 | [#20](https://github.com/Ayumu-J-S/llm_scratch/pull/20) | not exposed by runtime / not exposed by runtime | not exposed by runtime / not exposed by runtime | 1 | in progress | config-preflight, profile-composition, command-parity, evaluation-fallback |
...
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- | --- |
| not exposed by runtime / not exposed by runtime | 10 | 1 | 20 | 12 | 27 | Produced scoped EXP-001, DATA-001, DATA-002, MODEL-001, ENV-001, CFG-001, guarded-policy, canonical-tokenizer, and provenance changes; localized causal-boundary, immutable-manifest, tokenizer, model-invariant, CUDA-boundary, profile/preflight, source-separation, and final-head parity semantics; reviews found authority, lifecycle, identity, evidence, and workflow defects and independently reproduced the original MODEL-001 CPU gates | One implementation stalled; two review attempts blocked; CFG-001 first review found an evaluation execution-path contradiction; earlier passes missed accounting, benchmark authority, lifecycle, tokenizer/workflow integration, exact accepted-plan assertions, provider/evidence labels, and provenance source precedence; exact model attribution remains impossible | 2026-07-12 |
