...
| --- | --- | --- | --- | --- | ---: | --- | --- |
| [DATA-004 pinned baseline mixture](DATA-004-pinned-baseline-mixture.md) | DATA-004 | draft | not exposed by runtime / not exposed by runtime | pending | 0 | in progress | data-quality, split-leakage, token-mixture, cache-headroom, source-provenance |
