...
| [DATA-003 deterministic stream cursor](DATA-003-stream-cursor.md) | DATA-003 | [#29](https://github.com/Ayumu-J-S/llm_scratch/pull/29) (merged `57266e1`); P5 repair [#31](https://github.com/Ayumu-J-S/llm_scratch/pull/31) (draft) | not exposed by runtime / not exposed by runtime | not exposed by runtime / not exposed by runtime | 5 (P5 review pending) | in progress | deterministic-order, cursor-resume, packed-cursor-resume, completed-cursor, post-merge-reopen, repeat-policy, prefetch-equivalence, async-ack, pass-completion, process-cursor-propagation, process-reuse |
