...
| [LOOP-001 step/token budgets](LOOP-001-step-token-budgets.md) | LOOP-001 | [#25](https://github.com/Ayumu-J-S/llm_scratch/pull/25) (draft; pending parent merge) | not exposed by runtime / not exposed by runtime | not exposed by runtime / not exposed by runtime | 2 | PASS WITH NOTE | training-loop, token-weighting, cadence, numerical-stability, validation-evidence, runtime-identity |
