...
| [DATA-003 P5 post-merge audit](DATA-003-p5-post-merge-audit.md) | DATA-003 | [#32](https://github.com/Ayumu-J-S/llm_scratch/pull/32) (draft) | not exposed by runtime / not exposed by runtime | pending | 0 | in progress | post-merge-audit, merge-evidence, roadmap-state |
