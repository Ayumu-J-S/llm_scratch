...
| [LOOP-001 step/token budgets](LOOP-001-step-token-budgets.md) | LOOP-001 | draft / pending | not exposed by runtime / not exposed by runtime | pending | 0 | in progress | training-loop, token-weighting, cadence, runtime-identity |
