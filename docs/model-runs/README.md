...
| [DATA-003 packed resume repair](DATA-003-packed-resume-repair.md) | DATA-003 | [#31](https://github.com/Ayumu-J-S/llm_scratch/pull/31) (draft) | not exposed by runtime / not exposed by runtime | not exposed by runtime / not exposed by runtime | 2 | PASS WITH NOTE — implementation `4680026587`, no-drift `4680031289`, connector audit pending | resume, packed-cursor, token-accounting, completed-cursor |
...
| [DATA-003 deterministic stream cursor](DATA-003-stream-cursor.md) | DATA-003 | [#29](https://github.com/Ayumu-J-S/llm_scratch/pull/29) (merged `57266e1`); P5 repair [#31](https://github.com/Ayumu-J-S/llm_scratch/pull/31) (draft) | not exposed by runtime / not exposed by runtime | not exposed by runtime / not exposed by runtime | 5 | in progress — P5 PASS WITH NOTE, connector audit pending | deterministic-order, cursor-resume, packed-cursor-resume, completed-cursor, post-merge-reopen, repeat-policy, prefetch-equivalence, async-ack, pass-completion, process-cursor-propagation, process-reuse |
...
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- | --- |
| not exposed by runtime / not exposed by runtime | 12 | 2 | 28 | 20 | 41 | Produced scoped EXP-001, DATA-001, DATA-002, MODEL-001, ENV-001, CFG-001, REP-001, LOOP-001, guarded-policy, canonical-tokenizer, and provenance changes; localized causal-boundary, immutable-manifest, tokenizer, model-invariant, CUDA-boundary, profile/preflight, source-separation, run-identity, global-seeding, training-loop, token-weighting, metrics-lifecycle, W&B-failure preservation, final-head parity semantics, a scoped post-merge status correction, and final-partial/completed-cursor repairs independently passing with note | One implementation stalled; two review attempts blocked; LOOP-001 initial review found missing non-finite-state guards, token cadences, aggregate metrics, and strict budget safety, follow-up reviews found validation evidence context and metrics-lifecycle/W&B-init preservation gaps before repair; REP-001 follow-up review found missing dirty-worktree verification after the initial guard-ordering repair; CFG-001 first review found and repair closed an evaluation execution-path contradiction and profile coupling; DATA-003 post-merge review found final-partial packed residual duplication and exact P2 validation then found completed-cursor next-pass misclassification before implementation and no-drift PASS WITH NOTE reviews; connector audit remains pending; earlier passes missed accounting, benchmark authority, lifecycle, tokenizer/workflow integration, exact accepted-plan assertions, provider/evidence labels, and provenance source precedence; exact model attribution remains impossible | 2026-07-12 |
